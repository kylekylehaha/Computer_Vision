...
def main():
    ...
    # ====================================
    # xCenter = int(test_image.shape[0]/2)
    # yCenter = int(test_image.shape[1]/2)
    # test_image_padded = np.pad(test_image,((xCenter, xCenter), (yCenter, yCenter), (0, 0)), 'constant')
